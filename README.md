...
Ссылки на коды
[Самописный генератор Mersenne Twister (MT)](ссылка на репозиторий или файл)
[Библиотечный генератор MT (std::mt19937)](ссылка на репозиторий или файл)
[Генератор линейных конгруэнций (LCG)](ссылка на репозиторий или файл)
[Генератор Фибоначчи](ссылка на репозиторий или файл)
